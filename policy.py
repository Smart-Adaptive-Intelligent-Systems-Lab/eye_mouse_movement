...
if __name__ == "__main__":
    ...
    # Create student to learn from the behavior of the expert
    a2c_student = A2C('MlpPolicy', env_id, verbose=1)

    # Create expert dataset by allowing expert to interact with the enviroment
    # Storing resultant expert observations and actions
    #region
    ...
    # Instantiate ExpertDataset and split into training and testing
    #region
    ...
    print(f"\nMean reward of student before training = {mean_reward} +/- {std_reward}")
    ...
    mean_reward, std_reward = evaluate_policy(a2c_student, env, n_eval_episodes=10)
    print(f"\nMean reward of student after training = {mean_reward} +/- {std_reward}")